...
int main()
{
	...
	//Cuanto es el promedio general de reciduos
	for (int k = 0; k < 36; ++k)
	{
	...
	//Cuantas toneladas de reciduos organicos tiene excedente cada provincia:
	...
	//El promedio de residuos por año
